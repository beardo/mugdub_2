...
RSpec.describe GuessesController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all guesses as @guesses" do
      ...
      expect(assigns(:guesses)).to eq([guess])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested guess" do
        guess = Guess.create! valid_attributes
        put :update, {:id => guess.to_param, :guess => new_attributes}, valid_session
        guess.reload
    ...
    describe "with invalid params" do
      it "assigns the guess as @guess" do
        guess = Guess.create! valid_attributes
        put :update, {:id => guess.to_param, :guess => invalid_attributes}, valid_session
        expect(assigns(:guess)).to eq(guess)
      end
